...
export const gitIntegrationApi = {
    get: (projectId: string) => apiClient.get<GitIntegrationInfo | null>(`/projects/${projectId}/git-integration`).then((res) => res.data),
    ...
    delete: (projectId: string) => apiClient.delete(`/projects/${projectId}/git-integration`),
    getTaskCommits: (taskId: string) => apiClient.get<GitCommitItem[]>(`/tasks/${taskId}/git-commits`).then((res) => res.data),
};