...
import { useAutomationRules, useCreateAutomationRule, useToggleAutomationRule, useDeleteAutomationRule } from '../../hooks/useAutomation';
...
export function AutomationRulesPage() {
    ...
    const handleCreate = async () => {
        ...
        const actionParams = actionType === 'AssignToUser' || actionType === 'NotifyUser' ? JSON.stringify({ userId: actionUserId }) : '{}';

        await createRule.mutateAsync({ name: name.trim(), triggerType, triggerConditionJson: conditionJson, actionType, actionParamsJson: actionParams });
        setName('');
        setTriggerIssueType('');
        setActionUserId('');
    };
