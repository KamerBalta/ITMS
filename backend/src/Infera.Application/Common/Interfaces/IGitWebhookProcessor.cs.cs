...
public interface IGitWebhookProcessor
{
    ...
    System.Threading.Tasks.Task ProcessAzureDevOpsCheckinAsync(Guid projectId, string payloadJson, CancellationToken ct = default);
    System.Threading.Tasks.Task ProcessAzureDevOpsBuildAsync(Guid projectId, string payloadJson, CancellationToken ct = default);
    System.Threading.Tasks.Task ProcessAzureDevOpsReleaseAsync(Guid projectId, string payloadJson, CancellationToken ct = default);
}